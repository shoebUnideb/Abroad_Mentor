...
export const tokens = {
  getAccess:  (): string => localStorage.getItem('gile_access') ?? '',
  getRefresh: (): string => localStorage.getItem('gile_refresh') ?? '',
  setAccess:  (t: string) => localStorage.setItem('gile_access', t),
  set:        (a: string, r: string) => {
    localStorage.setItem('gile_access', a);
    localStorage.setItem('gile_refresh', r);
  },
  clear: () => {
    localStorage.removeItem('gile_access');
    localStorage.removeItem('gile_refresh');
  },
